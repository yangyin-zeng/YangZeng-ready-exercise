...
The suggestion is to place figures/tables/Rds files etc. in the `media` folder.

You could also pull it from the `results` folder, but the advantage of copying them into `media` is that you have everything related to your presentation in one place, and if content in `results` continues to be changed/updated, you can ensure you have the version you used in your presentation by copying it into `media`.
...
![](./media/height-weight.png){fig-align="center" width="420"}
